...
final class ProjectStore {
    ...
    static void remove(Context c,String p){ArrayList<String>a=all(c);a.remove(p);String next=a.isEmpty()?"":a.get(0);clearPackageMappings(c,p);c.getSharedPreferences(PREF,0).edit().putStringSet("projects",new HashSet<>(a)).putString("profile",next).apply();}
